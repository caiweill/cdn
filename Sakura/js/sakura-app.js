...
function imgError(ele, type) {
    switch (type) {
        case 1:
            ele.src = 'https://cdn.jsdelivr.net/gh/caiweill/cdn@latest/Sakura/img/Transparent_Akkarin.th.jpg';
            break;
        case 2:
            ele.src = 'https://gravatar.shino.cc/avatar/?s=80&d=mm&r=g';
            break;
        default:
            ele.src = 'https://cdn.jsdelivr.net/gh/caiweill/cdn@latest/Sakura/img/image-404.png';
    }
}
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://cdn.jsdelivr.net/gh/caiweill/cdn@latest/Sakura/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                        lazyload();
...
function coverVideoIni() {
    if ($('video').hasClass('hls')) {
        if (mashiro_global.variables.has_hls){
            ...
            $.getScript("https://cdn.jsdelivr.net/gh/caiweill/cdn@latest/Sakura/js/16.hls.js", function(){
                loadHls();
